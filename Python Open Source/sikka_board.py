from sikka_store import chance, community, board, property_info, utilities, properties
from sikka_player import Player
...
class Board:    # create the class for the board
